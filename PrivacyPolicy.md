...
- **Customer**: refers to the company, organization or person that signs up to use the Fixy Service to manage the relationships with your consumers or service users. - **Device**: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Fixy and use the services.
